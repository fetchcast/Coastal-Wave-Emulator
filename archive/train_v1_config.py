...
CONFIG: Dict[str, Any] = {
    ...
    "data_path": "/home/jovyan/swan/wavm-Waves_2019_2020_final.nc",
    "results_root": "/home/jovyan/swan/runs/focused_rerun_all_onefile",
    "log_file": "/home/jovyan/swan/focused_rerun_all_onefile.log",

    # Boundary settings
    "use_bnd": "on",
    "bnd_dir_2019": "/home/jovyan/swan/bnd_2019",
    "bnd_dir_2020": "/home/jovyan/swan/bnd_2020",
    ...
    "stage2_true_multiseed_seeds": [42, 123, 456],
...
def worker_main(job_file: str) -> int:
    ...
    try:
        ...
        if rank0:
            ...
            best_weight = find_single_file(run_dir, "*model_weights*.pth")
    ...
    while queue or running:
        ...
        for proc, gpu_group, job, job_file, fh_out, fh_err in running:
            ...
            if ret is None:
                ...
                continue
            # Process finished — close log handles
            fh_out.close()
            fh_err.close()
            ...
            if ret != 0:
                # Log last 80 lines of stderr for failed jobs (30 is too few —
