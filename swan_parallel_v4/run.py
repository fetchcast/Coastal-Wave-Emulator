...
def main(a):
    ...
    plan=jobs(bases['fno']);print('GPU 0,1: existing B/C. GPU 2,3: family evaluation. GPU 4..7: seven fixed baselines, 21 fits.',flush=True)
    ...
    with ExitStack() as stack:
        ...
        c.freeze(work/'controller_config.json',dict(version=4,server=str(server),gpu_lanes=dict(original=[0,1],evaluation=[2,3],baselines=[4,5,6,7]),
